<table>
    <tr>
        <th colspan="7" style="font-weight: bold; text-align: center;">REPORT RINGKASAN TRANSAKSI</th>
    </tr>
    <tr>
    ...
    @empty
    <tr>
        <td colspan="7" style="border: 1px solid #000;">Tidak ada data transaksi pada rentang tanggal ini.</td>
    </tr>
    @endforelse
